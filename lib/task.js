...
/**
  ...
  Return a promise that resolves when all file sets are completed.
...
/*
  ...
  Task writers should override this if their task is not
  file based, or they need special handling.
**/
...
/*
  Standard reference to iterating over a file.  Use this to do
  something with a file that doesn't involve reading its contents
  directly.
...
Task.prototype.thrown = function (exception) {
  console.log(exception);
};

/**
  Task runner invokes this.
*/
